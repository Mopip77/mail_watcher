...
def send_mail(mail_paths, print_success=False):
    ...
    for config_path, smtp_config in smtp_config_map.items():
        ...
        mail_sender.send_mails(mails_using_cur_smtp_config, smtp_config, print_success=print_success)
